...
<script language="javascript">
	function fn_imageUp() {
		//document.getElementById("editor_upimage").submit();
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	...
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="file_uploader.jsp" method="post" enctype="multipart/form-data">
        <div id="pop_content2">
...
<div style="display:none">
	<iframe id="procframe" name="procframe"></iframe>
</div>
