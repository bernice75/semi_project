	...
	<body>
		<%
			...
			if(command.equals("emailChk")) {
				...
				String user = "bernice159"; // 자신의 네이버 계정('@naver.com'은 적지 말 것)
				String password = "alflagood12!";// 자신의 네이버 패스워드
				int port = 465;
				// 메일 받을 주소
				...
				try {
					...
					msg.setFrom(new InternetAddress(user+"@naver.com", "Leporem"));
					msg.addRecipient(Message.RecipientType.TO, new InternetAddress(email));

					// 메일 제목
					msg.setSubject("안녕하세요  Leporem 인증 메일입니다.");
					// 메일 내용
